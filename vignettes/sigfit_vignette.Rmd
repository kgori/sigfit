...
* Three collections of __COSMIC mutational signatures__: original set of 30 signatures (v2, 2015) and updated sets of 67 signatures (v3, 2019) and 78 signatures (v3.2, 2021). The v3 signature set is also available in transcriptional strand-wise version (192 mutation types). These data can be loaded using:
