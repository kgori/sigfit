...
#include "stanExports_sigfit_fitex_emu.h"

RCPP_MODULE(stan_fit4sigfit_fitex_emu_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_sigfit_fitex_emu")
