...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(56, 56, "end", "model_sigfit_ext_emu");
    return reader;
}
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            {
                ...
                stan::math::assign(lambda, elt_multiply(multiply(exposures,signatures_mat),opps));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
        ...
        try {
            ...
            for (int g = 1; g <= G; ++g) {
                ...
                lp_accum__.add(poisson_log<propto__>(get_base1(counts,g,"counts",1), get_base1(lambda,g,"lambda",1)));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
