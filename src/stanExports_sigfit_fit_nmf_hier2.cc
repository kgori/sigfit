...
#include "stanExports_sigfit_fit_nmf_hier2.h"

RCPP_MODULE(stan_fit4sigfit_fit_nmf_hier2_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_sigfit_fit_nmf_hier2")
