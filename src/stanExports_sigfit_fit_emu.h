...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(23, 2, "restart", "model_sigfit_fit_emu");
    reader.add_event(54, 31, "end", "model_sigfit_fit_emu");
    return reader;
}
...
public:
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("multiplier", "G", G);
        context__.validate_dims("parameter initialization", "multiplier", "double", context__.to_vec(G));
        std::vector<double> multiplier(G, double(0));
        size_t multiplier_k_0_max__ = G;
        for (size_t k_0__ = 0; k_0__ < multiplier_k_0_max__; ++k_0__) {
            multiplier[k_0__] = vals_r__[pos__++];
        }
        size_t multiplier_i_0_max__ = G;
        ...
        try {
            ...
            for (int g = 1; g <= G; ++g) {
                ...
                stan::model::assign(activities, 
                            ...
                            multiply(transpose(get_base1(exposures, g, "exposures", 1)), get_base1(multiplier, g, "multiplier", 1)), 
...
typedef model_sigfit_fit_emu_namespace::model_sigfit_fit_emu stan_model;
