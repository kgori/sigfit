...
namespace model_sigfit_fitext_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_sigfit_fitext");
    ...
    reader.add_event(70, 2, "restart", "model_sigfit_fitext");
    reader.add_event(214, 144, "end", "model_sigfit_fitext");
    return reader;
}
...
#include <stan_meta_header.hpp>
 class model_sigfit_fitext : public prob_grad {
private:
        int family;
        int C;
        int S;
        ...
        int T;
public:
    model_sigfit_fitext(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_sigfit_fitext_namespace::model_sigfit_fitext";
        ...
        try {
            ...
            validate_non_negative_index("kappa", "(S + N)", (S + N));
            context__.validate_dims("data initialization", "kappa", "vector_d", context__.to_vec((S + N)));
            kappa = Eigen::Matrix<double, Eigen::Dynamic, 1>((S + N));
            vals_r__ = context__.vals_r("kappa");
            pos__ = 0;
            size_t kappa_j_1_max__ = (S + N);
            ...
            G_notdpp = int(0);
            stan::math::fill(G_notdpp, std::numeric_limits<int>::min());
            stan::math::assign(G_notdpp,(logical_eq(dpp, 0) ? G : 0 ));
            ...
            validate_non_negative_index("exposures_all", "T", T);
            validate_non_negative_index("exposures_all", "G_notdpp", G_notdpp);
            num_params_r__ += ((T - 1) * G_notdpp);
            current_statement_begin__ = 110;
            validate_non_negative_index("exposures_fixed", "S", S);
            validate_non_negative_index("exposures_fixed", "G_dpp", G_dpp);
            num_params_r__ += ((S - 1) * G_dpp);
            current_statement_begin__ = 111;
            validate_non_negative_index("exposures_sticklengths", "(N + 1)", (N + 1));
            validate_non_negative_index("exposures_sticklengths", "G_dpp", G_dpp);
            num_params_r__ += ((N + 1) * G_dpp);
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        current_statement_begin__ = 107;
        if (!(context__.contains_r("exposures_all")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable exposures_all missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("exposures_all");
        pos__ = 0U;
        validate_non_negative_index("exposures_all", "T", T);
        validate_non_negative_index("exposures_all", "G_notdpp", G_notdpp);
        context__.validate_dims("parameter initialization", "exposures_all", "vector_d", context__.to_vec(G_notdpp,T));
        std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> > exposures_all(G_notdpp, Eigen::Matrix<double, Eigen::Dynamic, 1>(T));
        size_t exposures_all_j_1_max__ = T;
        size_t exposures_all_k_0_max__ = G_notdpp;
        for (size_t j_1__ = 0; j_1__ < exposures_all_j_1_max__; ++j_1__) {
            for (size_t k_0__ = 0; k_0__ < exposures_all_k_0_max__; ++k_0__) {
                exposures_all[k_0__](j_1__) = vals_r__[pos__++];
            }
        }
        size_t exposures_all_i_0_max__ = G_notdpp;
        for (size_t i_0__ = 0; i_0__ < exposures_all_i_0_max__; ++i_0__) {
            try {
                writer__.simplex_unconstrain(exposures_all[i_0__]);
            } catch (const std::exception& e) {
                stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable exposures_all: ") + e.what()), current_statement_begin__, prog_reader__());
            }
        }

        current_statement_begin__ = 110;
        if (!(context__.contains_r("exposures_fixed")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable exposures_fixed missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("exposures_fixed");
        pos__ = 0U;
        validate_non_negative_index("exposures_fixed", "S", S);
        validate_non_negative_index("exposures_fixed", "G_dpp", G_dpp);
        context__.validate_dims("parameter initialization", "exposures_fixed", "vector_d", context__.to_vec(G_dpp,S));
        std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> > exposures_fixed(G_dpp, Eigen::Matrix<double, Eigen::Dynamic, 1>(S));
        size_t exposures_fixed_j_1_max__ = S;
        size_t exposures_fixed_k_0_max__ = G_dpp;
        for (size_t j_1__ = 0; j_1__ < exposures_fixed_j_1_max__; ++j_1__) {
            for (size_t k_0__ = 0; k_0__ < exposures_fixed_k_0_max__; ++k_0__) {
                exposures_fixed[k_0__](j_1__) = vals_r__[pos__++];
            }
        }
        size_t exposures_fixed_i_0_max__ = G_dpp;
        for (size_t i_0__ = 0; i_0__ < exposures_fixed_i_0_max__; ++i_0__) {
            try {
                writer__.simplex_unconstrain(exposures_fixed[i_0__]);
            } catch (const std::exception& e) {
                stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable exposures_fixed: ") + e.what()), current_statement_begin__, prog_reader__());
            }
        }

        current_statement_begin__ = 111;
        if (!(context__.contains_r("exposures_sticklengths")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable exposures_sticklengths missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("exposures_sticklengths");
        pos__ = 0U;
        validate_non_negative_index("exposures_sticklengths", "(N + 1)", (N + 1));
        validate_non_negative_index("exposures_sticklengths", "G_dpp", G_dpp);
        context__.validate_dims("parameter initialization", "exposures_sticklengths", "vector_d", context__.to_vec(G_dpp,(N + 1)));
        std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> > exposures_sticklengths(G_dpp, Eigen::Matrix<double, Eigen::Dynamic, 1>((N + 1)));
        size_t exposures_sticklengths_j_1_max__ = (N + 1);
        size_t exposures_sticklengths_k_0_max__ = G_dpp;
        for (size_t j_1__ = 0; j_1__ < exposures_sticklengths_j_1_max__; ++j_1__) {
            for (size_t k_0__ = 0; k_0__ < exposures_sticklengths_k_0_max__; ++k_0__) {
                exposures_sticklengths[k_0__](j_1__) = vals_r__[pos__++];
            }
        }
        size_t exposures_sticklengths_i_0_max__ = G_dpp;
        for (size_t i_0__ = 0; i_0__ < exposures_sticklengths_i_0_max__; ++i_0__) {
            try {
                writer__.vector_lub_unconstrain(0, 1, exposures_sticklengths[i_0__]);
            } catch (const std::exception& e) {
                stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable exposures_sticklengths: ") + e.what()), current_statement_begin__, prog_reader__());
            }
        }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            current_statement_begin__ = 107;
            std::vector<Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> > exposures_all;
            size_t exposures_all_d_0_max__ = G_notdpp;
            exposures_all.reserve(exposures_all_d_0_max__);
            for (size_t d_0__ = 0; d_0__ < exposures_all_d_0_max__; ++d_0__) {
                if (jacobian__)
                    exposures_all.push_back(in__.simplex_constrain(T, lp__));
                else
                    exposures_all.push_back(in__.simplex_constrain(T));
            }

            current_statement_begin__ = 110;
            std::vector<Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> > exposures_fixed;
            size_t exposures_fixed_d_0_max__ = G_dpp;
            exposures_fixed.reserve(exposures_fixed_d_0_max__);
            for (size_t d_0__ = 0; d_0__ < exposures_fixed_d_0_max__; ++d_0__) {
                if (jacobian__)
                    exposures_fixed.push_back(in__.simplex_constrain(S, lp__));
                else
                    exposures_fixed.push_back(in__.simplex_constrain(S));
            }

            current_statement_begin__ = 111;
            std::vector<Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> > exposures_sticklengths;
            size_t exposures_sticklengths_d_0_max__ = G_dpp;
            exposures_sticklengths.reserve(exposures_sticklengths_d_0_max__);
            for (size_t d_0__ = 0; d_0__ < exposures_sticklengths_d_0_max__; ++d_0__) {
                if (jacobian__)
                    exposures_sticklengths.push_back(in__.vector_lub_constrain(0, 1, (N + 1), lp__));
                else
                    exposures_sticklengths.push_back(in__.vector_lub_constrain(0, 1, (N + 1)));
            }
            ...
            std::vector<Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> > exposures(G, Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1>(T));
            stan::math::initialize(exposures, DUMMY_VAR__);
            stan::math::fill(exposures, DUMMY_VAR__);
            ...
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, Eigen::Dynamic> activities(G, T);
            ...
            if (as_bool(logical_eq(dpp, 1))) {
                ...
                for (int g = 1; g <= G; ++g) {
                    ...
                    stan::model::assign(exposures, 
                                ...
                                build_exposures_from_sticks_and_fixed(get_base1(exposures_sticklengths, g, "exposures_sticklengths", 1), get_base1(exposures_fixed, g, "exposures_fixed", 1), pstream__), 
                                "assigning variable exposures");
                }
            } else {
                ...
                for (int g = 1; g <= G; ++g) {
                    ...
                    stan::model::assign(exposures, 
                                stan::model::cons_list(stan::model::index_uni(g), stan::model::nil_index_list()), 
                                get_base1(exposures_all, g, "exposures_all", 1), 
                                "assigning variable exposures");
                }
            }
            ...
            for (int g = 1; g <= G; ++g) {
                ...
                if (as_bool(logical_eq(dpp, 1))) {
                    ...
                    lp_accum__.add(dirichlet_log<propto__>(get_base1(exposures_fixed, g, "exposures_fixed", 1), rep_vector(1, S)));
                    current_statement_begin__ = 167;
                    lp_accum__.add(beta_log<propto__>(get_base1(exposures_sticklengths, g, "exposures_sticklengths", 1), 1, get_base1(dp_alpha, g, "dp_alpha", 1)));
                } else {

                    current_statement_begin__ = 170;
                    lp_accum__.add(dirichlet_log<propto__>(get_base1(exposures_all, g, "exposures_all", 1), kappa));
                }
            }
    ...
    void get_param_names(std::vector<std::string>& names__) const {
        ...
        names__.push_back("exposures_all");
        names__.push_back("exposures_fixed");
        names__.push_back("exposures_sticklengths");
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_sigfit_fitext_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> > exposures_all;
        size_t exposures_all_d_0_max__ = G_notdpp;
        exposures_all.reserve(exposures_all_d_0_max__);
        for (size_t d_0__ = 0; d_0__ < exposures_all_d_0_max__; ++d_0__) {
            exposures_all.push_back(in__.simplex_constrain(T));
        ...
        for (size_t j_1__ = 0; j_1__ < exposures_all_j_1_max__; ++j_1__) {
            for (size_t k_0__ = 0; k_0__ < exposures_all_k_0_max__; ++k_0__) {
                vars__.push_back(exposures_all[k_0__](j_1__));
            }
        }

        std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> > exposures_fixed;
        size_t exposures_fixed_d_0_max__ = G_dpp;
        exposures_fixed.reserve(exposures_fixed_d_0_max__);
        for (size_t d_0__ = 0; d_0__ < exposures_fixed_d_0_max__; ++d_0__) {
            exposures_fixed.push_back(in__.simplex_constrain(S));
        ...
        for (size_t j_1__ = 0; j_1__ < exposures_fixed_j_1_max__; ++j_1__) {
            for (size_t k_0__ = 0; k_0__ < exposures_fixed_k_0_max__; ++k_0__) {
                vars__.push_back(exposures_fixed[k_0__](j_1__));
            }
        }

        std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> > exposures_sticklengths;
        size_t exposures_sticklengths_d_0_max__ = G_dpp;
        exposures_sticklengths.reserve(exposures_sticklengths_d_0_max__);
        for (size_t d_0__ = 0; d_0__ < exposures_sticklengths_d_0_max__; ++d_0__) {
            exposures_sticklengths.push_back(in__.vector_lub_constrain(0, 1, (N + 1)));
        ...
        for (size_t j_1__ = 0; j_1__ < exposures_sticklengths_j_1_max__; ++j_1__) {
            for (size_t k_0__ = 0; k_0__ < exposures_sticklengths_k_0_max__; ++k_0__) {
                vars__.push_back(exposures_sticklengths[k_0__](j_1__));
            }
        }
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (size_t j_1__ = 0; j_1__ < exposures_all_j_1_max__; ++j_1__) {
            for (size_t k_0__ = 0; k_0__ < exposures_all_k_0_max__; ++k_0__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "exposures_all" << '.' << k_0__ + 1 << '.' << j_1__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
        }
        size_t exposures_fixed_j_1_max__ = S;
        ...
        for (size_t j_1__ = 0; j_1__ < exposures_fixed_j_1_max__; ++j_1__) {
            for (size_t k_0__ = 0; k_0__ < exposures_fixed_k_0_max__; ++k_0__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "exposures_fixed" << '.' << k_0__ + 1 << '.' << j_1__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
        }
        size_t exposures_sticklengths_j_1_max__ = (N + 1);
        ...
        for (size_t j_1__ = 0; j_1__ < exposures_sticklengths_j_1_max__; ++j_1__) {
            for (size_t k_0__ = 0; k_0__ < exposures_sticklengths_k_0_max__; ++k_0__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "exposures_sticklengths" << '.' << k_0__ + 1 << '.' << j_1__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
        }
        size_t dp_alpha_k_0_max__ = G_dpp;
    ...
    void unconstrained_param_names(std::vector<std::string>& param_names__,
        ...
        size_t exposures_all_j_1_max__ = (T - 1);
        size_t exposures_all_k_0_max__ = G_notdpp;
        for (size_t j_1__ = 0; j_1__ < exposures_all_j_1_max__; ++j_1__) {
            for (size_t k_0__ = 0; k_0__ < exposures_all_k_0_max__; ++k_0__) {
                param_name_stream__.str(std::string());
        ...
        size_t exposures_fixed_j_1_max__ = (S - 1);
        size_t exposures_fixed_k_0_max__ = G_dpp;
        for (size_t j_1__ = 0; j_1__ < exposures_fixed_j_1_max__; ++j_1__) {
            for (size_t k_0__ = 0; k_0__ < exposures_fixed_k_0_max__; ++k_0__) {
                param_name_stream__.str(std::string());
...
typedef model_sigfit_fitext_namespace::model_sigfit_fitext stan_model;
