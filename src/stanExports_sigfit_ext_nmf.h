...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(23, 2, "restart", "model_sigfit_ext_nmf");
    reader.add_event(60, 37, "end", "model_sigfit_ext_nmf");
    return reader;
}
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            validate_non_negative_index("kappa_vec", "S", S);
            kappa_vec = Eigen::Matrix<double, Eigen::Dynamic, 1>(S);
            stan::math::fill(kappa_vec, DUMMY_VAR__);
            stan::math::assign(kappa_vec,rep_vector(kappa, S));

            // execute transformed data statements

            // validate transformed data
            current_statement_begin__ = 34;
            check_greater_or_equal(function__, "kappa_vec", kappa_vec, 0);
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            stan::math::assign(probs, multiply(array_to_matrix(exposures, pstream__), array_to_matrix(signatures, pstream__)));
...
typedef model_sigfit_ext_nmf_namespace::model_sigfit_ext_nmf stan_model;
